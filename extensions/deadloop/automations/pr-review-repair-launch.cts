...
- On technical, validation, invariant, or push failure, write "summary":"<three sentences>" plus status="blocked", result={reason:"typed_reason_code",explanation:"what failed",recovery:"safe next step"}, and evidence={}.
