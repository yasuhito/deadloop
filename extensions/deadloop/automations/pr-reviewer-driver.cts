...
function envConfig(source: NodeJS.ProcessEnv = process.env) {
  return {
    ...
    branchUpdateModel: source.DEADLOOP_BRANCH_UPDATE_MODEL || "",
    repairModel: source.DEADLOOP_REPAIR_MODEL || "",
...
- For blocked reports include "summary":"<three sentences>", result={reason:"add_request|free_storage|fix_environment|fix_verification_policy",explanation:"what failed",recovery:"safe next step"}, and evidence={}.
...
- On merge, validation, invariant, or push failure, write "summary":"<three sentences>" plus status="blocked", result={reason:"add_request|free_storage|fix_environment|fix_verification_policy",explanation:"what failed",recovery:"safe next step"}, and evidence={}.
