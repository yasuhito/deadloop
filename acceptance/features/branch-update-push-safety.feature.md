...
## シナリオ: branch 更新の選定前から作業場所に変更がある場合は更新を停止する

* 前提 branch 更新の選定前から作業場所に未コミットの変更がある
* もし deadloop が branch 更新方法を選定する
* ならば branch 更新方法は作業場所の変更を理由に停止となる

## シナリオ: 選定対象の pull request head が事前確認から変わった場合は更新を停止する

* 前提 選定対象の pull request head が事前確認した head と異なる
* もし deadloop が branch 更新方法を選定する
* ならば branch 更新方法は古い head を理由に停止となる

## シナリオ: 自動チェック後に追跡中の変更がある場合は branch を更新しない

* 前提 更新前に確認した pull request head がある
* かつ 自動チェック後に作業場所へ追跡中の変更がある
* もし deadloop が branch 更新を完了しようとする
* ならば branch への push は行われない
